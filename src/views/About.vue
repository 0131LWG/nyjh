<template>
  <div class="back">
    ...
    <div class="introduce">
      ...
      <div class="introduce-text">东莞市南粤净化科技有限公司位于东莞市水乡片区麻涌镇。背靠黄浦江，南接长安虎门。自2010年成立，公司经营者秉承质量为本、服务至上、不忘初心、向内自省，向外求新的理念！致力于空气洁净领域的产品研发、生产、销售、安装和检测。</div>
      <div class="introduce-text">主要产品有初、中、高效空气过滤器、耐高温过滤器、洁净单元FFU、净化工作台、传递窗、高效排风箱、不锈钢制品等净化设备、净化工程的设计与安装！公司在2006年通过ISO9001和ISO14001认证。</div>
      <div class="introduce-text">拥有最先进的净化产品生产设备及洁净车间生产线！所有出厂高效均通过自检。为新材料膜切行业、光学光电、半导体、智能智造、新能源、医院医疗体系、食品饮料、汽车制造等行业提供全方位洁净领域的完整解决方案。</div>
      <div class="introduce-text">目前合作的客户有：伯恩光学 拓斯达智能 航天华阳 丽珠集团 可口可乐 健帆生物等。</div>
    </div>
    <div class="vision">
